...
public sealed record GetCartItemByIdQuery(int CartId, int CartItemId, bool IncludeDeps = false) : IncludeDepsQuery(IncludeDeps), IQueryRequest<CartItemObjectModels.ItemModel>;