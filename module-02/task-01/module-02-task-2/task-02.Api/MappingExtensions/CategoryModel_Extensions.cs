...
internal static class CategoryModelExtensions
{
    ...
    public static CategoryResponse.CreatedDto ToCategoryResponseCreatedDto(this CategoryObjectModels.ItemModel value, params ResourceLink[] links)
        => value == null
            ? null
            : new CategoryResponse.CreatedDto(value.ToCategoryResponseItemDto(), links);
