...
public class CategoriesController : ControllerBase
{
    ...
    {
        var foundCategory = await _mediator.Send(new GetCategoryByIdQuery(categoryId));
    ...
    {
        var categoryId = await _mediator.Send(model.ToCreateCategoryCommand());
    
        return CreatedAtAction("GetById", new { categoryId }, null);
    }
