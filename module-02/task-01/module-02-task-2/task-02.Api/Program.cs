...
using Module_02.Task_02.BLL.CQRS;
...
{
    configuration.RegisterServicesFromAssemblyContaining<BaseHandler<IStudyReadOnlyDbContext>>();
});


services.AddScoped<IWithTrackingStudyDbContext, WithTrackingStudyDbContext>();
services.AddScoped<IStudyReadOnlyDbContext, StudyReadOnlyDbContext>();
...
{
    var dbContext = serviceScope.ServiceProvider.GetRequiredService<IWithTrackingStudyDbContext>();
