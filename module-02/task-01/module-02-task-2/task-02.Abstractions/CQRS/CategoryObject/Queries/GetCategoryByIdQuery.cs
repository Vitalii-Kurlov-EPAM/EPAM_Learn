...
public sealed record GetCategoryByIdQuery(int CategoryId, bool IncludeDeps = false) : IncludeDepsQuery(IncludeDeps), IQueryRequest<CategoryObjectModels.ItemModel>;